...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        vim.api.nvim_buf_set_keymap(
            ...
            "n",
            "<CA-a>",
            '<ESC>:w<CR>:TermExec direction=float cmd="$myCClassName=Read-Host;New-Item .\\$myCClassName.c;exit"<CR>',
            { silent = true, noremap = true }
        )
        vim.api.nvim_buf_set_keymap(
            0,
            "n",
            "<CA-h>",
            '<ESC>:w<CR>:TermExec direction=float cmd="$myCClassName=Read-Host;if (Get-Item ../include) {cd ../include/;New-Item .\\$myCClassName.h;cd ../src} elseif(Get-Item ./include) {cd ./include;New-Item .\\$myCClassName.h;cd ..} else {New-Item .\\$myCClassName.h};exit"<CR>',
            { silent = true, noremap = true }
        )
        vim.api.nvim_buf_set_keymap(
            0,
            "n",
            "<CA-c>",
            '<ESC>:w<CR>:TermExec direction=float cmd="$myCClassName=Read-Host;if (Get-Item ../include) {New-Item .\\$myCClassName.c;cd ../include/;New-Item .\\$myCClassName.h;cd ../src} elseif(Get-Item ./include) {New-Item .\\$myCClassName.c;cd ./include;New-Item .\\$myCClassName.h;cd ..} else {New-Item .\\$myCClassName.c,.\\$myCClassName.h};exit"<CR>',
            { silent = true, noremap = true }
        )
    end,
})
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        vim.api.nvim_buf_set_keymap(
            ...
            "n",
            "<CA-a>",
            '<ESC>:w<CR>:TermExec direction=float cmd="$myPythonName=Read-Host;New-Item .\\$myPythonName.py;exit"<CR>',
            { silent = true, noremap = true }
        )
    end,
})
