...
require("which-key").add({
    ...
    { "<Space>ca", "<cmd>CMakeGenerate<CR>",                                                                                            desc = "Generate",              nowait = true, remap = false },
    { "<Space>cb", "<cmd>CMakeBuild<CR>",                                                                                               desc = "Build",                 nowait = true, remap = false },
    ...
    { "<Space>cr", "<cmd>CMakeRrun<CR>",                                                                                                desc = "Run",                   nowait = true, remap = false },
